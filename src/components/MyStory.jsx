...
const MyStory = () => {
  ...
  return (
    ...
    >
      ...
      <h2>Who I am</h2>
      <p>
        I'm a 31-year-old man originally from Chile who on 2014 moved to Sweden.
      ...
      <p>
        ...
        on the countryside, surrounded by nature and agricultural fields. That's
      ...
      <p>
        ...
        the digitalization of data the Earth's surface. When I took that course,
      ...
      <p>
        ...
        work hard in whatever I could find, mostly in cleaning and restaurant
      ...
      <p>
        ...
        Lund University, where I had advanced courses on Geographical
        ...
        had studied until then could be stored in web servers and displayed from
        anywhere on the planet through a web browser. It was the first time I
        saw the internet as the powerful technology that it really is. How to
        contribute to the world, without considering using the internet as my
        ally? Web technologies have become crucial for solving many of today's
        global issues.
      </p>
      <p>
        ...
        and React), WordPress, RESTful APIs, PHP (Laravel), Node.js (Express),
        MySQL, MongoDB, OAuth, WebSockets and AGILE practices, among other
        topics.
      </p>
      <h2>What I want</h2>
      <p>
        I want to become not only a great developer, but also a professional
        able to help in our planet's problems, bringing knowledge to people and
        helping them by developing web applications. I would really like to
        build tools that make the use of our time and resources more efficient,
      ...
      <p>
        ...
        – and talk about how we could save the world? Don't doubt on reaching
